...
export class KngUserReminderComponent implements OnInit {
  ...
  constructor(
    ...
    // ✅ FIXED: Utiliser user de getLatestCoreData au lieu de loader
    this.user = user;
    if (this.user && this.user.reminder && this.user.reminder.weekdays && this.user.reminder.weekdays.length > 0) {
