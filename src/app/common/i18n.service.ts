...
export class i18n  {
  ...
  public fr: any = {
    ...
    nav_store: 'Marchés locaux ',
    nav_store_sublong: 'D\'autres jours de livraison ? Changez de marché !',
    nav_store_description: 'Découvrez la disponibilité des marchés locaux.',
  ...
  public en: any = {
    ...
    nav_store: 'Local markets ',
    nav_store_sublong: 'Want other delivery days? Switch markets!',
    nav_store_description: 'Discover the availability of local markets.',
