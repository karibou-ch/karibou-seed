...
export class i18n  {
  ...
  public fr: any = {
    ...
    audio_support_contact:'Contactez-nous par téléphone ou décrivez votre demande avec le microphone.',
    audio_support_response:'Votre message:',
    audio_support_send:'Envoyer votre message',
    audio_support_anonymous:'Pour que nous puissions vous répondre, indiquez votre email ou votre téléphone.',
    audio_support_contact_placeholder:'Email ou téléphone',
    audio_support_or:'Ou',
    audio_support_account:'créez un compte / connectez-vous',
    audio_support_sent:'Votre message a bien été envoyé.',
    audio_support_error:'Votre message n’a pas pu être envoyé. Veuillez réessayer.',
    ...
    cart_audio_vendor: 'Votre message sera traité par le commerçant...',
    ...
    james_title_cta:'Assistant recettes',
    ...
    nav_store_sublong: 'D\'autres jours de livraison ? Changez de marché !',
    nav_store_subshort: 'Envie d’encore plus de choix ?',
    ...
    nav_subscription:'Livraisons régulières',
    nav_subscription_b2b:'Kits Pros 5🌟',
    ...
    user_address_note: 'Note au livreur, collecte, code, remarques',
  ...
  public en: any = {
    ...
    audio_support_contact:'Contact us by phone or describe your request with the microphone.',
    audio_support_response:'Your message:',
    audio_support_send:'Send your message',
    audio_support_anonymous:'To receive a reply, enter your email address or phone number.',
    audio_support_contact_placeholder:'Email or phone number',
    audio_support_or:'Or',
    audio_support_account:'create an account / sign in',
    audio_support_sent:'Your message has been sent.',
    audio_support_error:'Your message could not be sent. Please try again.',
    action_ko: 'Retry!',
    action_check: 'Check',
    action_save: 'Save!',
    action_del: 'Delete',
    ...
    cart_audio_vendor: 'Your message will be processed by the merchant...',
    ...
    james_title_cta:'Recipe Assistant',
    ...
    nav_store_subshort: 'Looking for even more choice? ',
    ...
    nav_subscription:'Regular deliveries',
    nav_subscription_b2b:'Best Kits 5🌟',
    ...
    user_address_note: 'Note to the deliveryman, pick up, door code, remarks',
