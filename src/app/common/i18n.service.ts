...
export class i18n  {
  ...
  public fr: any = {
    ...
    cart_audio: 'Enregistrez vos souhaits avec un message audio.',
    ...
    nav_store: 'On peut toujours changer de marché ',
    nav_store_sub: 'Remplissez vos paniers chez les commerçants de plusieurs marchés et recevez toutes vos envies en une seule livraison',
    ...
    karibou_news_ko:'Je lirais plus tard',
  ...
  public en: any = {
    ...
    cart_audio: 'Record your special request for the merchant with an audio message.',
    ...
    nav_store: 'I start with my prefered market',
    nav_store_sub: 'Fill your baskets from several markets and receive all your desires in a single delivery',
