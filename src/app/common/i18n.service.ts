...
export class i18n  {
  ...
  public fr: any = {
    ...
    cart_address_add: 'Gérer vos adresses de livraison',
    ...
    nav_shipping: 'Je choisis mon jour de livraison',
    nav_shipping_off: 'Cette journée n\'est plus disponible',
    nav_shortcuts: 'Les raccoursis',
    nav_store: 'Je choisis un marché de ma région',
    nav_store_sub: 'Remplissez votre panier chez les commerçants d’un même marché et recevez toutes vos envies en une seule livraison',
