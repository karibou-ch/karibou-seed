...
export class i18n  {
  ...
  public fr: any = {
    ...
    cart_audio: 'Enregistrez vos souhaits avec un message audio. Et pensez a bien adapter la quantité de budget à votre commande.',
  ...
  public en: any = {
    ...
    cart_audio: 'Record your special request for the merchant with an audio message. Remember to adapt the budget quantity to your order.',
