...
export class i18n  {
  ...
  public fr: any = {
    ...
    james_feedback_title:'1000 mercis pour vos retours essentiels pour améliorer James :-]',
    ...
    nav_subscription:'Abonnements pour les particuliers',
    nav_subscription_b2b:'Offres Entreprise',
  ...
  public en: any = {
    ...
    nav_subscription:'Customer souscription',
    nav_subscription_b2b:'Business Offers',
