...
export class i18n  {
  ...
  public fr: any = {
    ...
    nav_subscription:'Les Abos',
    nav_subscription_b2b:'Entreprises',
    ...
    subscription_switch:'Activer pour recevoir les articles avec un abonnement',
    subscription_status_on:'L\'abonnement est disponible pour la sélection suivante',
    subscription_status_off:'Vous pouvez tester les produits sans abonnement',
  };
  ...
  public en: any = {
    ...
    nav_subscription:'For Subs',
    nav_subscription_b2b:'For Businness',
