        ...
        safeFetch(req) {
            return __awaiter(this, void 0, void 0, function* () {
                try {
                    ...
                    console.log('---DEBUG SW 1',_a);
                    return this.adapter.newResponse('', {
                        status: 504,
                        statusText: 'Gateway Timeout (1)',
                    });
                }
            });
        }
        ...
        handleFetchWithPerformance(req, ctx, lru) {
            return __awaiter$1(this, void 0, void 0, function* () {
                ...
                if (res === undefined) {
                    ...
                    res = this.adapter.newResponse(null, { status: 504, statusText: 'Gateway Timeout (2)' });
            ...
            if (this.config.timeoutMs !== undefined) {
                ...
                const safeNetworkFetch = (() => __awaiter$1(this, void 0, void 0, function* () {
                    try {
                        ...
                        console.log('---DEBUG SW 3',_a);
                        return this.adapter.newResponse(null, {
                            status: 504,
                            statusText: 'Gateway Timeout (3)',
                        });
                    }
                }))();
        ...
        safeFetch(req) {
            return __awaiter$1(this, void 0, void 0, function* () {
                try {
                    ...
                    console.log('---DEBUG SW 4',_a);
                    return this.adapter.newResponse(null, {
                        status: 504,
                        statusText: 'Gateway Timeout (4)',
                    });
                }
            });
        }
        ...
        safeFetch(req) {
            return __awaiter$5(this, void 0, void 0, function* () {
                try {
                    ...
                    console.log('---DEBUG SW 5',err);
                    this.debugger.log(err, `Driver.fetch(${req.url})`);
                    return this.adapter.newResponse(null, {
                        status: 504,
                        statusText: 'Gateway Timeout (5)',
                    });
                }
            });
        }
